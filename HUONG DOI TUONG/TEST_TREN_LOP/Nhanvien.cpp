...
void DanhSachNhanVien(NhanVien *&nv, int m, int *&luong) {
...
void InDanhSachNhanVien(NhanVien *nv, int m) {
    cout << "\nDanh sach nhan vien:\n";
    for (int i = 0; i < m; i++) {
...
void NhapThiSinh(ThiSinh *&ts,int k){
    ts =new ThiSinh[k];
